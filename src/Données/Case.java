...
/**
 * Représente une case de la grille de pIQross.
 * @author Genest
 */
public class Case 
{
     ...
     */
    public enum Etat{COLORE, NON_COLORE, MAUVAISE_COULEUR, FAUX, DRAPEAU, ANIME, SUPPRESSION, AJOUT};
    
    /**
     * Enumeration représentant les couleurs pouvant être affichées sur la grille.
     */
    public enum Couleur{NC, BLANC, BLEU, JAUNE, ORANGE, ROUGE, VERT, ROSE, MARRON};
    ...
    /**
     * Retourne la couleur de la case qui est affichée sur la grille au format Color.
     * @return La couleur de la case.
     */
    ...
    /**
     * Convertie couleurGrille, de type Couleur en Color pour permettre une utilisation plus facile en mode graphique.
