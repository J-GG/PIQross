...
public class Grille implements GrilleObservable {
    ...
    /**
     * Tableau d'ArrayList à deux dimensions contenant la valeur des indices des
     * colonnes et leurs couleurs. Le premier tableau correspond à la colonne et
     * le second, à la valeur ou à la couleur. Ex : indicesColonnes[1][1].get(0)
     * permet de récupérer la couleur du premier indice de la 2ème colonne.
     */
    private ArrayList[][] indicesColonnes;

    /**
     * Tableau d'ArrayList à deux dimensions contenant la valeur des indices des
     * lignes et leurs couleurs. Le premier tableau correspond à la ligne et le
     * second, à la valeur ou à la couleur. Ex : indicesLignes[1][1].get(0)
     * permet de récupérer la couleur du premier indice de la 2ème ligne.
     */
    ...
    /**
     * Permet de savoir si toutes les cases de la grille sont noires. Si c'est
     * le cas, on pourra considérer la grille complète.
     */
    ...
    /**
     * Charge la grille contenue dans le fichier passé en paramètre et d'autres
     * informations. Si le fichier est incorrecte, une exception est levée.
     *
    ...
    /**
     * Crée une grille vide. Le fichier passé en paramètre ne contient donc pas
     * encore la grille.
     *
    ...
    /**
     * Retourne le plus grand nombre d'indices pour la colonne de la grille en
     * ayant le plus.
     *
    ...
    /**
     * Retourne le plus grand nombre d'indices pour la ligne de la grille en
     * ayant le plus.
     *
    ...
    /**
     * Permet de récupérer le plateau de Case représentant la grille jouée par
     * le joueur.
     *
    ...
    /**
     * Permet de remplir le tableau de Case à partir du fichier ainsi que de
     * récupérer les autres informations de la grille.
     *
    ...
    /**
     * Récupère la colonne et la ligne de la case sélectionnée et modifie la
     * grille du joueur en conséquence.
     *
     * @param colonne Numéro de la colonne de la case jouée.
     * @param ligne Numéro de la ligne de la case jouée.
     * @param clicEffet Permet de savoir si le joueur a voulu marquer la case
     * d'un drapeau ou jouer.
