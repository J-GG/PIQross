...
/**
 * Interface implémentant le DP Observer permettant de prévenir les observateur du changement de l'état d'une grille.
 * @author Genest
 */
public interface GrilleObservable
{
    ...
    /**
     * Prévient les observateurs que la case sélectionnée l'est avec une mauvaise couleur.
     */
