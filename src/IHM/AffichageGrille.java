...
public abstract class AffichageGrille extends JPanel
{
    ...
    /**
     * La taille d'un côté d'une image représentant une case. Exprimée en pixels.
     */
    ...
    /**
     * Le plus grand nombre d'indices pour la colonne de la grille en ayant le plus. Permet d'allouer la bonne dimension pour la grille.
     */
    protected int maxIndicesColonnes;
    
    /**
     * Le plus grand nombre d'indices pour la ligne de la grille en ayant le plus. Permet d'allouer la bonne dimension pour la grille.
     */
    ...
    /**
     * Nombre de lignes dans le menu de droite contenant les couleurs. Permet de savoir où placer les lignes horizontales blanches derrière la grille.
     */
