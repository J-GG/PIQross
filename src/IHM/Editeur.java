...
public class Editeur extends ConteneurGrille
{
    ...
    /**
     * Vaut vrai si il faut afficher la grille, faux si il faut afficher l'aperçu.
     */
    ...
    /**
     * Ajoute la ligne et colonne de la grille affichée à la grille de l'Editeur.
     */
     ...
     * @param e Evènement généré par la souris permettant de connaitre sa position.
     */
     ...
     * @return Vrai si il faut afficher la grille, faux si il faut afficher l'aperçu.
     */
    ...
    /**
     * Permet de récupérer la couleur de la case sur laquelle est la souris et la sélectionner dans la couleur pour l'aperçu.
     */
