...
public class Jeu extends ConteneurGrille
{
    ...
    /**
     * Construit l'interface du jeu comprenant la zone de la grille et le menu à droite.
    ...
    public Jeu(final Fenêtre parent, Grille g)
    {
        ...
        /**
         * Récupère le bouton de souris qui est préssé. Associé au MouseMotionAdapter, permet de remplir les cases en Drag and Drop.
         */
    ...
    public class Chronometre implements ActionListener
    {
        ...
        /**
         * Crée un Chronomètre qui compte le temps écoulé en seconde. Le délai associé dans le Timer doit donc être d'une seconde.
