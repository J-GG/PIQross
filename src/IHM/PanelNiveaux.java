...
/**
 * Conteneur affichant la liste des niveaux de pIQcross.
 *
 * @author J-GG
 */
public class PanelNiveaux extends JPanel {
    ...
    /**
     * Nombre de lignes (contenant les informations des niveaux) pouvant être
     * affichées à la fois.
     */
    ...
    /**
     * Tous les niveaux ne pouvant êter affichés, n° de celle affichée en
     * premier. Change en scrollant.
     */
                    ...
                    if (chooser.getFile() != null) {
                        ...
                        } catch (GrilleException ex)//Sinon, on affiche un message d'erreur
                        {
                            timer = new Timer(1500, new ActionListener() {
                                ...
                                /**
                                 * Indique que le message liée à l'erreur de
                                 * fichier doit-être affiché.
                                 */
                                @Override
    ...
    /**
     * Dessine le contenu de PanelNiveaux. Cette méthode affiche donc la liste
     * des niveaux.
     *
